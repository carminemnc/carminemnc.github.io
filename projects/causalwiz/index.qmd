...
The package is accompanied by a series of <a href="projects.html" class="cool-link">articles</a>, *written in Italian*, covering theoretical foundations of causal inference and practical implementations of the methods implemented in `causalwiz`.
